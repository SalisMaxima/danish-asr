#!/bin/bash
#BSUB -J danish_asr_eval_e6_full
#BSUB -q gpua100
#BSUB -n 4
...
#BSUB -o /work3/s204696/logs/lsf/eval_e6_full_%J.out
...
#   EVAL_CONFIG=configs/fairseq2/300m/ctc-eval-e6-read-aloud.yaml \
#       bsub < scripts/hpc/300m/21_eval_e6_full.sh
...
echo "=== Phase 8B: 300M Finetuned E6 Evaluation ==="
