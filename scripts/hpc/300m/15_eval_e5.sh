...
#BSUB -o /work3/s204696/logs/lsf/eval_e5_%J.out
#BSUB -e /work3/s204696/logs/lsf/eval_e5_%J.err
#
...
if ! python scripts/hpc/run_eval.py \
    ...
    --config "$CONFIG" \
    --wandb-tags "e5,40k,lr3e-5,freeze2k,test"; then
